        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default toggle">
                ...
                <div class="panel-heading">
                    ...
                    <button class="btn btn-primary" onclick="backList();">用户管理</button>
                    </c:if>
                </div>
                ...
                <div class="panel-body ">
                    ...
                    <div class="col-md-4">
                        <div class="up-img-cover"  id="up-img-touch" >
                            <img class="am-circle" alt="点击图片上传" src="${ctx}${user.headImg}" data-am-popover="{content: '点击上传', trigger: 'hover focus'}" >
                        </div>
                    </div>
                    </center>
                    <div class="col-md-8">
                        <form class="form-horizontal group-border hover-stripped" role="form" action="${ctx}/back/userSave" method="post">
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-2 control-label">登录名</label>
                                <div class="col-lg-10 col-md-10">
                                    <input type="text" class="form-control" placeholder="Type your email" name="loginName" value="${user.loginName}">
                                </div>
                            </div>
                            <!-- End .form-group  -->
                            <div class="form-group">
                            ...
                            <!-- End .form-group  -->
                            <div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-12 control-label">角色</label>
                                <label class="radio-inline">
                                    <input type="radio" name="role" value="author" <c:if test="${user.role eq 'author'}">checked="checked"</c:if>>作者
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="role" value="admin" <c:if test="${user.role eq 'admin'}">checked="checked"</c:if> >管理员
                                </label>
                            </div>
                            <!-- End .form-group  -->
                            <div class="form-group">
...
//绑定上传事件
    ...
    function backList(){
        window.location.href = "${ctx}/back/userList";
    }
</script>
</body>
</html>
