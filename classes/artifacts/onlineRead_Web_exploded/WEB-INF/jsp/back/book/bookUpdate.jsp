        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default toggle">
                ...
                <div class="panel-heading">
                    ...
                    <button class="btn btn-primary" onclick="javascript:history.back();">图书管理</button>
                </div>
                    ...
                    <center>
                        <div class="col-md-4">
                            <div class="up-img-cover"  id="up-img-touch" >
                                <img class="am-circle" alt="点击图片上传" src="${ctx}${book.headImg}" data-am-popover="{content: '点击上传', trigger: 'hover focus'}" >
                            </div>
                        </div>
                    </center>
                    <div class="col-md-8">
                        <form class="form-horizontal group-border hover-stripped" role="form" action="${ctx}/back/bookSave" method="post">
                            <input type="hidden" name="id" value="${book.id}">
                            <input type="hidden" name="headImg" id="headImg" value="${book.headImg}"/>
                            <input type="hidden" name="author.id" value="${loginUser.id}">
                            <div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-12 control-label">名称</label>
                                <div class="col-lg-10 col-md-10">
                                    <input type="text" class="form-control" placeholder="名称" name="name" value="${book.name}" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-2 control-label">简称</label>
                                <div class="col-lg-10 col-md-10">
                                    <input type="text" class="form-control" placeholder="简称"  name="simpleName" value="${book.simpleName}">
                                </div>
                            </div>
                            <!-- End .form-group  -->
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    <textarea class="form-control limitTextarea" name="description" maxlength="250" rows="6">${book.description}</textarea>
                                </div>
                            </div>
                            <!-- End .form-group  -->
                            <div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-12 control-label">类别</label>
                                <div class="col-lg-10 col-md-10">
                                    <select class="form-control" name="bookType.id">
                                        <c:forEach items="${bookTypeList}" var="type">
                                            <option value="${type.id}"  <c:if test="${type.id eq book.bookType.id}">selected</c:if> >${type.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
