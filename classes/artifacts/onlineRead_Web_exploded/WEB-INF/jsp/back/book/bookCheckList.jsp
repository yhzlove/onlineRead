                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <c:if test="${'0' eq book.checkFlag}">
                                                <a href="${ctx}/back/bookCheck?id=${book.id}&checkFlag=1" ><i class="fa-ok s24"></i>通过</a>
                                                <a href="${ctx}/back/bookCheck?id=${book.id}&checkFlag=2" ><i class="fa-remove s24"></i>不通过</a>
                                            </c:if>
                                            <c:if test="${'1' eq book.checkFlag}">
                                                <c:if test="${'0' eq book.recommend}">
                                                    <a href="${ctx}/back/bookCheck?id=${book.id}&recommend=1"><i class="fa-hand-up s24"></i>推荐</a>
                                                </c:if>
                                                <c:if test="${'1' eq book.recommend}">
                                                    <a href="${ctx}/back/bookCheck?id=${book.id}&recommend=0" onclick="return confirm('确定取消推荐')"><i class="fa-hand-down s24"></i>取消推荐</a>
                                                </c:if>
                                            </c:if>
                                        </td>
                                    </tr>
