...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 heading">
            <h1 class="page-header">审查关键字管理</h1>
            <div class="option-buttons">
                <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group dropdown">
                        <a class="btn dropdown-toggle" href="${ctx}/back/censorUpdate"><i class="en-plus s32"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel panel-default plain toggle panelClose panelRefresh">
                    ...
                    <div class="panel-body">
                        <table class="table display" id="datatable">
                            ...
                            <tbody>
                            <c:forEach items="${censorList}" var="censor" >
                                <tr class="odd gradeX">
                                    <td>${censor.word}</td>
                                    <td><fmt:formatDate value="${censor.registTime}" pattern="yyyy/MM/dd" /></td>
                                    <td>
                                        <a href="${ctx}/back/censorUpdate?id=${censor.id}"><i class="ec-pencil s24"></i>修改</a>
                                        <a href="${ctx}/back/censorDelete?id=${censor.id}" onclick="return confirm('是否删除该数据')"><i class="fa-remove s24"></i>删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
